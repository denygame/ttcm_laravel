      ...
      <div class="orbit banner-slider" role="region" data-orbit>
        <ul class="orbit-container">
          ...
          <li class="orbit-slide is-active slide">
            <img src="source/img/slider/1.jpg" class="orbit-image">
            <div class="orbit-caption back-none fullwidth vertical-center">
              <div class="slide-content center-content">
                <h4 class="light text-cap">New Collection</h4>
                <h2 class="bold text-upp">SWEET & SEXY LINGERIE</h2>
                <h5 class="text-upp medium">Only over  oder on $99.99</h5>
                <div class="slider-link-wrap">
                  <a href="" class="my-button bold text-upp back-none">Purchase now</a>
                  <a href="" class="my-button bold text-upp back-none">Shop now</a>
                </div>                
              </div>
            </div>
          </li>
          ...
          <li class="orbit-slide is-active slide">
            <img src="source/img/slider/2.jpg" class="orbit-image">
            <div class="orbit-caption back-none fullwidth vertical-center">
              <div class="slide-content center-content">
                <h4 class="light text-cap">New Collection</h4>
                <h2 class="bold text-upp">SWEET & SEXY LINGERIE</h2>
          ...
          <li class="orbit-slide is-active slide">
            <img src="source/img/slider/3.jpg" class="orbit-image">
            <div class="orbit-caption back-none fullwidth vertical-center">
              <div class="slide-content center-content">
                <h4 class="light text-cap">New Collection</h4>
                <h2 class="bold text-upp">SWEET & SEXY LINGERIE</h2>
  ...
  <section id="top-banner">
    <div class="row banner-wrap">
      <div class="relative top-banner-item banner-hover">
        ...
        <img src="source/img/banner/1.jpg " class="banner-img">
      </div>
      <div class="relative top-banner-item top-center-banner" style="margin:0 3.1%">
        <div class="relative top-center-banner-item banner-hover" style="margin-bottom: 6%;">
          <div class="hover-border"></div>
          <img src="source/img/banner/2.png" class="banner-img">
        </div>
        <div class="relative top-center-banner-item banner-hover">
          <div class="hover-border"></div>
          <img src="source/img/banner/b-3.png" class="banner-img">
        </div>
      </div>
      <div class="relative top-banner-item banner-hover">
        <div class="hover-border"></div>
        <img src="source/img/banner/4.jpg" class="banner-img">
      </div>
    </div>
  </section>
  <!-- END BANNER -->
